...
export function EmployeeLogin({
  ...
  return (
    <div className="fixed inset-0 w-full overflow-hidden flex items-end justify-center bg-gradient-to-br from-blue-50 to-purple-50 px-5 pb-[calc(env(safe-area-inset-bottom)+48px)] pt-[calc(env(safe-area-inset-top)+80px)]">

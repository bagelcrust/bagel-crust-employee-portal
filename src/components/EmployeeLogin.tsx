...
export function EmployeeLogin({
  ...
  return (
    <div className="fixed inset-0 w-full overflow-hidden flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 px-5 py-[calc(env(safe-area-inset-top)+60px)]">

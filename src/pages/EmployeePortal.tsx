...
export default function EmployeePortal_B() {
  ...
  return (
    <div className="w-full overflow-hidden flex flex-col bg-gradient-to-br from-blue-50 to-purple-50"
      ...
      {/* Bottom Navigation Bar - Thick Underline */}
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                padding: '8px 4px',
                border: 'none',
                background: activeTab === key ? 'rgba(37, 99, 235, 0.05)' : 'transparent',
                cursor: 'pointer',
                transition: 'all 0.2s ease',
                flex: 1,
                position: 'relative',
                borderBottom: activeTab === key ? '5px solid #2563EB' : '5px solid transparent',
                boxShadow: activeTab === key ? '0 4px 8px rgba(37, 99, 235, 0.15)' : 'none'
              }}
            >
              <div style={{
                fontSize: '24px',
